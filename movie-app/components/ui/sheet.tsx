...
function SheetContent({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <Dialog.Close className="absolute right-4 top-4 rounded-lg opacity-70 transition-opacity hover:opacity-100 focus:outline-none focus:ring-3 focus:ring-ring/50 disabled:pointer-events-none">
